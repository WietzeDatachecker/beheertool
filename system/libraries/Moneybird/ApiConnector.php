...
require_once (BASEPATH.'libraries/Moneybird/Exceptions.php');
require_once (BASEPATH.'libraries/Moneybird/Object.php');
require_once (BASEPATH.'libraries/Moneybird/Contact.php');
require_once (BASEPATH.'libraries/Moneybird/Invoice.php');
require_once (BASEPATH.'libraries/Moneybird/RecurringTemplate.php');
require_once (BASEPATH.'libraries/Moneybird/Company.php');
...
class MoneybirdApi
{
	...
	{
		// Set defaults
		$this->clientname = $clientname != null ? $clientname : 'datachecker';
		$username	= $username != null ? $username : 'api@datachecker.nl';
		$password = $password != null ? $password : 'WebrandApiDataC!';

		//Dit is voor de test
		//$this->clientname = $clientname != null ? $clientname : 'webrandit';
		//$username	= $username != null ? $username : 'yarno.vanoort@webrandit.nl';
		//$password = $password != null ? $password : '1fietser';
