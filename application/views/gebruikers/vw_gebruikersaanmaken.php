...
<div class="container">
      <div class="row">
        ...
        <div class="span8">
        	...
        	<form class="form-horizontal pull-left " id="registerHere" method="post" action="<?php echo base_url();?>index.php/gebruikers/insert_gebruiker">
	  <fieldset>
	 ...
	 <div class="control-group">
		<label class="control-label" for="input01">Gebruikersnaam<span style="color:red;">*</span> </label>
	      <div class="controls">
	        <input type="text" class="input-xlarge" id="gebruikersnaam" name="gebruikersnaam" > (Bij NVM Woontoets gebruik je het NVM nummer)
	       
	      </div>
	</div>
	 <div class="control-group">
		<label class="control-label" for="input01">Aantal controles <span style="color:red;">*</span> </label>
	      <div class="controls">
	...
	<div class="control-group">
		<label class="control-label" for="input01">Prijs per controle <span style="color:red;">*</span> </label>
	      <div class="controls">
	        <input type="text" class="input-xlarge" id="aantal_checks" name="prijs_per_check" >
	       
	      </div>
	</div>
	<div class="control-group">
		<label class="control-label" for="input01">Licentiekosten per jaar <span style="color:red;">*</span> </label>
	      <div class="controls">
	        <input type="text" class="input-xlarge" id="aantal_checks" name="licentie_pj"  value="350">  (Bij geen licentiekosten veld leeg maken)
